...
<div class="row">
    <main>
        <div class="login-bodycard">
            ...
            <form method="POST">
                <div>
                    <input type="password" name="jelszo1" id="login-input" placeholder="Jelszó" required>
                </div>
                <div>
                    <input type="password" name="jelszo2" id="login-input" placeholder="Jelszó újra" required>
                </div>
                <div>
